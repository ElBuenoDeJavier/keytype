        ...
        <header className="bg-gray-950 font-mono absolute p-7 w-screen">
            <nav className="flex justify-between items-center mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {dataUsuario?<div  className='text-white flex'>Hola, {dataUsuario.name}<svg className="h-8 w-8 text-indigo-800 hover:text-indigo-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button onClick={pulsarBotonLogin} className="text-white px-5 py-2 rounded-full bg-indigo-800 hover:bg-indigo-500">Iniciar sesión</button>
                </div>
            </nav>
        </header>
    );
